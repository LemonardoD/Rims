import { varchar, bigint, pgTable, serial, integer, index } from "drizzle-orm/pg-core";
...
export const vendors = pgTable(
	...
	table => {
		return {
			rimId: index("rimId_index").on(table.rimId),
			rimConfigId: index("rimConfigId_index").on(table.rimConfigId),
		};
	}
);
